...
<center><img src="20210911_192751.png"style="height:80px;"></center>
  <div class="wrapper">
    <center><h2><i>ENTERPSE EXCHANGE</i></h2></center>
    <form  method="POST">
	...
	if(isset($_POST['submit'])){
		...
		$subject='REGARDING OF DOCTOCARE ENTERPRISE ADMIN COMPLAIN/SUGGESTION REQUEST';
		$msg="Thank you ".$name." "."of". " ".$from." happy to see you in our doctocare enterprise system. Your quires for ticket id"." ". $a ." will be solve shortly have a great day for any inconvinece mail us your quires is for our priority."."If needed our executive call to your given number"." ".$num."." ."\n\n Subject:-". " " .$msg."\n\n\nyour faithfully \nAdmin.doctocare@enterprise.com".".";
		$headers="From: $from ";
