...
<head>
    ...
    <link rel="stylesheet"type="text/css"href="ADMAINLogin.css">
...
<?php
    ...
    <div class="hero">
        <div class="form-box">
            ...
            <form action="view2.php" class="input-group" id="login" method="POST" >
                <input type="text" name="id" class="input-field" placeholder="ADMIN ID" required>
           ...
           $conn = mysqli_connect($servername, $username, $password, $database);
            ...
            if(($apassword == $cpassword)&& $exists==false){
              ...
              $sql_e = "SELECT `id` FROM `adminlogin`  WHERE id='$id'";
              ...
              $sql = "INSERT INTO `adminlogin` ( `id`, `pass`, `cpass`) VALUES ( '$id', '$apassword', '$cpassword');";
